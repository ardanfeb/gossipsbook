...
var ZegoExpressManager = /** @class */ (function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                console.log('startPublishingStream: ', this.localParticipant.streamID);
                return [
                  4 /*yield*/,
  ...
  ZegoExpressManager.prototype.setLocalVideoView = function (renderView) {
    ...
    console.log('startPreview: ', zegoView);
    zego_express_engine_reactnative_1.default
      .instance()
  ...
  ZegoExpressManager.prototype.leaveRoom = function () {
    ...
    return zego_express_engine_reactnative_1.default.instance().stopPublishingStream();
  ...
  ZegoExpressManager.prototype.onRoomStreamUpdate = function (fun) {
    return zego_express_engine_reactnative_1.default
      .instance()
      .on('roomStreamUpdate', function (roomID, updateType, streamList) {
        ...
        fun(updateType, streamIDList, roomID);
      });
  };
